...
public class UserServiceImpl implements IUserService {
    ...
    public ResponseDTO<UserDTO> loginUser(UserDTO userDTO) {
        ...
        stringRedisTemplate.opsForValue().set("USER_" + token, JSON.toJSONString(selectedUserDTO), 30*60, TimeUnit.SECONDS);
        return ResponseDTO.successByMsg(selectedUserDTO, "Successful Log-in");
