...
//    private UserDao userDao;
    ...
    public ResponseDTO<Boolean> saveAppoint(AppointDTO appointDTO) {
        // 进行统一表单验证
        //JDBCController.wholeList(appointDTO.getDoctorId(),appointDTO.getAppointTime());
//        JdbcTemplate jdbcTemplate = new JdbcTemplate();
//        String sql="select cnt from hospital_manager.left where id=appointDTO.getDoctorId() & tim=appointDTO.getAppointTime()";
//        List<Map<String,Object>> list_maps = jdbcTemplate.queryForList(sql);
//        if(ResponseDTO.successByMsg(true,list_maps.iterator().toString()));
        //return ResponseDTO.successByMsg(true, JDBCController.wholeList(appointDTO.getDoctorId(),appointDTO.getAppointTime()));
